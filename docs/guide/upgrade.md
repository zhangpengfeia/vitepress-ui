...
<script lang="ts" setup>
  ...
  import plusZhCn from "@zhangpengfeia/t-ui-plus/locale/zh-cn"
  import plusEn from "@zhangpengfeia/t-ui-plus/locale/en"
...
```js
// v1.5.2 样式引入
import "@zhangpengfeia/t-ui-plus/lib/style.css"

// v2.0.1 样式入
import "@zhangpengfeia/t-ui-plus/index.css"
```
