...
const formOpts = reactive<FormTypes.FormOpts>({
  ...
  rules: {
    ...
    hobby1: [{ required: true, message: "请选择爱好1", trigger: "change" }],
    hobby: [{ type: "array", required: true, message: "请至少选择一个爱好", trigger: "change" }],
    createDate: [{ required: true, message: "请选择年份", trigger: "change" }],
    date: [{ required: true, message: "请选择日期", trigger: "change" }],
    valDate1: [{ required: true, message: "请选择月份范围", trigger: "change" }],
    valDate2: [{ required: true, message: "请选择日期范围", trigger: "change" }],
    valDate3: [{ required: true, message: "请选择时间范围", trigger: "change" }],
    hobby2: [{ required: true, message: "请选择虚拟列表", trigger: "change" }],
    deptCode1: [{ required: true, message: "请选择部门", trigger: "change" }],
    deptCode: [{ required: true, message: "请选择下拉选择表格-单选", trigger: "change" }],
    createDeptCode: [{ required: true, message: "请选择下拉选择表格-多选", trigger: "change" }]
  },
  operatorList: [
